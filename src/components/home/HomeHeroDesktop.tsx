        ...
        <div className='relative rotate-z-1 hidden md:flex w-[90%] h-full border-[#7296F6] border-b-24 border-r-24 rounded-4xl'>
            ...
            <div className='relative w-full flex justify-center items-center'>
                <div className='bg-light-blue flex justify-center items-center min-h-full sm:p-2 lg:p-4 rounded-bl-4xl rounded-tl-4xl'>
                    <Image src={"/home/left-side.webp"} className='-rotate-z-1 sm:w-[80%] lg:w-full h-auto' alt='left psp' width={300} height={300}></Image>
                </div>
                    ...
                    <div className='relative z-1 bg-[url("/home/rcn.webp")] bg-cover bg-center w-full h-full'>
                        ...
                        <div className='relative w-full h-full flex flex-col justify-center items-center'>
                            <div className='relative w-[90%] h-fit flex flex-col justify-center items-center'>
                                <Image src={"/home/welcome-text.svg"} alt='welcome text' width={100} height={100} className='sm:w-[80%] lg:w-1/2 h-auto'></Image>
                                <Image src={"/home/to-su-text.svg"} alt='to su text' width={100} height={100} className='sm:w-[70%] lg:w-1/3 h-auto'></Image>
                                <Image src={"/home/your-creative-tech-text.webp"} alt='your creative tech text' width={100} height={100} className='sm:w-1/2 lg:w-1/4 absolute sm:-top-[25%] lg:-top-[35%] right-0 h-auto'></Image>
                                <span className='mt-8'></span>
                                <LinkButton size='xl' href="/">{`Start >`}</LinkButton>
                            </div>
                            <Image src={"/home/veno-laptop.webp"} className='absolute z-2 bottom-8 sm:left-0 lg:left-18 sm:w-32 lg:w-64 h-auto' width={100} height={100} alt='SU Veno Laptop'></Image>
                        </div>
                ...
                <div className='bg-light-blue min-h-full sm:p-1 lg:p-4 flex justify-center items-center rounded-br-4xl rounded-tr-4xl'>
                    <Image src={"/home/right-side.webp"} className='-rotate-z-1 sm:w-[80%] lg:w-full h-auto' alt='right psp' width={300} height={300}></Image>
                </div>
            </div>
        </div>
    )
