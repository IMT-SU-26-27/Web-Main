...
export async function AchievementFeatured() {
  ...
  return (
    <section className="bg-gradient-to-b pb-24 -mt-0.5 from-[#4A74D8] to-[#214DB0] min-h-screen w-screen overflow-x-hidden flex flex-col justify-center items-center">
      <div className="relative bg-[#7E3E11] border-2 border-black rounded-2xl p-4 md:p-8 w-[90%] md:w-[80%] flex justify-center items-center">
        <div className="relative flex flex-col justify-center items-center z-1 bg-gradient-to-b rounded-lg border-2 from-[#FFD7AB] to-[#FFE6CD] w-full min-h-full p-4">
          ...
          />
          <h3 className="text-lg md:text-xl text-[#543737] font-pixelify">{`Explore IMT people's achievements!`}</h3>
